                  ...
                  {isOpen && (
                    <div className="p-4 bg-white flex flex-col gap-4">
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        {chapter.pdfDocument && (
                          <button
                            onClick={() => router.push(`/view-pdf-simple?url=${encodeURIComponent(chapter.pdfDocument)}&title=${encodeURIComponent(chapter.title)}`)}
               ...
               {hasAccess && (
                      ...
                      {isVideoOpen && hasVideo && (
                        <div className="w-full aspect-video rounded-lg overflow-hidden shadow-md border border-gray-300">
                          <iframe
                            src={getYouTubeEmbedUrl(chapter.video)}
                            title={chapter.title}
